...
export default function Page() {
  ...
  if (
    ...
    /*
     * ActiveSession يتوقع Recommendation
     * وفيه potentialProfit وليس potential.
     */
    const recommendation = {
      lot:
        tradingCalculation?.lot ?? 0,
      riskMoney:
        tradingCalculation?.riskMoney ?? 0,
      potentialProfit:
        tradingCalculation?.potentialProfit ?? 0,
    };
    return (
      <ActiveSession
        session={session}
